"""Deploy: calendario light mode + seccion por-que-participar"""
import paramiko, os
...
print('\n=== [1] Dashboard.vue (calendario user) ===')
up(sftp, 'resources/js/Pages/User/Dashboard.vue')

print('\n=== [2] Admin Calendario (calendario admin) ===')
up(sftp, 'resources/js/Pages/Admin/Calendario/Index.vue')

print('\n=== [3] Welcome.vue (seccion por que participar) ===')
