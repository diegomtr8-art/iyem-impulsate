...
# Fix 1: Upload routes/web.php with dashboard redirect fix
print('\n--- Fix 1: routes/web.php ---')
upload_file(sftp,
    os.path.join(LOCAL_ROOT, 'routes', 'web.php'),
    f'{REMOTE_ROOT}/routes/web.php')

# Fix 2: Upload build assets to public/build/ (the path Laravel actually reads)
print('\n--- Fix 2: Build assets to public/build/ ---')
upload_dir(sftp,
