"""Deploy — Perfil de negocio real: credito, contraentrega, factura, perfil_completo"""
...
ssh.close()
print('\n=== DEPLOY PERFIL NEGOCIO REAL COMPLETADO ===')
print('Panel proveedor: https://impulsate.iyemyucatan.com/restaurantero/panel')
print('Perfil publico:  https://impulsate.iyemyucatan.com/restauranteros/{id}')
print('Admin Show:      https://impulsate.iyemyucatan.com/admin/restauranteros/{id}')
print('Directorio:      https://impulsate.iyemyucatan.com/proveedores')
