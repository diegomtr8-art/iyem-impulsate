...
print('\n--- Build assets ---')
# IMPORTANTE: Hostinger sirve desde public_html/public/ como DocumentRoot
# El build DEBE ir a public/build/, no a build/ directamente
upload_dir(sftp, os.path.join(LOCAL_ROOT, 'public', 'build'), f'{REMOTE_ROOT}/public/build')
