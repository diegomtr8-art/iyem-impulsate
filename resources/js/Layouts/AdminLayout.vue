...
const adminNavItems = [
    ...
    { label: 'Agenda',            routeName: 'admin.agenda.index',         icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zM8 15h.01M12 15h.01M16 15h.01' },
