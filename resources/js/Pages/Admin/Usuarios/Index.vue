                        ...
                        <tr v-for="usuario in usuarios.data" :key="usuario.id"
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <Link :href="route('admin.clientes.editar', usuario.id)"
                                        class="text-gray-400 dark:text-gray-400 hover:text-guinda-700 dark:hover:text-guinda-400 transition-colors p-1.5 hover:bg-guinda-50 dark:hover:bg-guinda-500/10 rounded-lg" title="Editar usuario">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
