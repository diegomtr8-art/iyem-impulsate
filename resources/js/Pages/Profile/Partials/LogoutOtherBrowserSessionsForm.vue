...
<template>
    <ActionSection>
        ...
        <template #description>
            Administra y cierra las sesiones activas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Si es necesario, puedes cerrar sesión en todos tus otros dispositivos. Algunas sesiones recientes se muestran a continuación. Si crees que tu cuenta fue comprometida, actualiza tu contraseña también.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Ingresa tu contraseña para confirmar que deseas cerrar sesión en tus otros dispositivos.
