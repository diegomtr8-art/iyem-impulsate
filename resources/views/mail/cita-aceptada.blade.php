...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <tr><td style="padding:32px 40px;">
        ...
        <p style="margin:0 0 24px;font-size:15px;color:#6b7280;">El proveedor ha <strong style="color:#15803d;">aceptado</strong> tu cita. Aquí tienes los detalles:</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:24px;">
            ...
            <tr><td style="padding:20px 24px;border-bottom:1px solid #e5e7eb;">
                <p style="margin:0 0 4px;font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#9ca3af;font-weight:600;">Fecha y hora confirmada</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff7f7;border:1px solid #fbc4cd;border-radius:12px;margin-bottom:24px;">
