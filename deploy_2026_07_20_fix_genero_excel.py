"""Deploy 2026-07-20 (3): Fix clasificacion de genero (campo faltaba en
$fillable de User, se guardaba en silencio sin error) + boton Exportar a
Excel en Metricas (nuevo MetricasExport con 7 hojas).
"""
import paramiko, os
...
up(sftp, 'app/Exports/MetricasExport.php')
...
print('\n=== Verificacion ruta exportar ===')
run(ssh, f'cd {RROOT} && /usr/bin/php artisan route:list 2>&1 | grep -i "metricas"')
