"""Deploy: Mejoras paneles comprador y proveedor — 10 funcionalidades nuevas"""
import paramiko, os
...
run(ssh, 'cd ' + RROOT + ' && php artisan route:list --path=notificaciones 2>&1 | tail -5')
...
print('  - Panel Comprador: banner perfil, notificaciones, countdown, búsqueda proveedores')
print('  - Panel Comprador: badge disponibilidad, editar notas, keywords visibles')
print('  - Panel Proveedor: barra progreso perfil, alerta 2h, necesidades comprador')
print('  - Panel Proveedor: Ver perfil público, 5 KPIs, notificaciones in-app')
print('  - Fix: sitio_web del comprador ahora persiste correctamente en BD')
