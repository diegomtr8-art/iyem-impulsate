"""Deploy V8 patch — controladores y archivos nuevos no incluidos en deploy_v7.py"""
...
# ── Assets compilados (nuevo build V8) ───────────────────────────────────────
print('\n=== Assets compilados ===')
updir(sftp, 'public/build', 'public/build')
updir(sftp, 'public/build', 'build')

# ── Controladores V8 (no estaban en deploy_v7.py) ────────────────────────────
print('\n=== Controladores V8 ===')
up(sftp, 'app/Http/Controllers/Admin/UserAdminController.php')
