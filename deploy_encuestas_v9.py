"""Deploy V9 — Plantilla encuestas, métricas/acordeón, prueba, envío desde panel, filtro CANIRAC"""
...
up(sftp, 'app/Models/EncuestaPlantilla.php')          # NUEVO

# ── Servicio ─────────────────────────────────────────────────────────────────
print('\n=== Servicio ===')
up(sftp, 'app/Services/EncuestaEnvioService.php')      # NUEVO
...
# ── Migraciones ──────────────────────────────────────────────────────────────
print('\n=== Migraciones ===')
up(sftp, 'database/migrations/2026_06_22_100829_create_encuesta_plantillas_table.php')
up(sftp, 'database/migrations/2026_06_22_100835_add_prueba_fields_to_encuestas_satisfaccion_table.php')

# ── Correr migrate en servidor ────────────────────────────────────────────────
print('\n=== php artisan migrate ===')
...
ssh.close()
print('\n=== DEPLOY V9 ENCUESTAS COMPLETADO ===')
print('URL: https://impulsate.iyemyucatan.com/admin/encuestas')
