"""Deploy — badge perfil completo en Admin > Restauranteros + directorio de proveedores de la plataforma"""
...
ssh.close()
print('\n=== DEPLOY COMPLETADO ===')
print('Verificar en: https://impulsate.iyemyucatan.com/proveedores')
print('Admin:        https://impulsate.iyemyucatan.com/admin/restauranteros/{id}')
