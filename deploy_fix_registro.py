"""Deploy — Fix registro evento: ValidationException + error en modal"""
...
print('\n=== [1/3] Controlador EventoRegistroController ===')
up(sftp, 'app/Http/Controllers/EventoRegistroController.php')

print('\n=== [2/3] Assets compilados (TabEventos corregido) ===')
...
print('\n' + '='*60)
print('DEPLOY LISTO — Fix registro evento activo en produccion')
