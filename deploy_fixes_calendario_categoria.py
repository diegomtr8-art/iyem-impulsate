...
# Fix 1 & 2: Build assets (Dashboard.vue compilado — calendario con initialDate + light mode CSS)
print('\n--- Fix 1 & 2: Build assets (calendario usuario) ---')
upload_dir(sftp,
    os.path.join(LOCAL_ROOT, 'public', 'build'),
    f'{REMOTE_ROOT}/public/build')

# Fix 3: Filtro por categorias — archivos PHP
print('\n--- Fix 3: Categoria en proveedores ---')
files_to_upload = [
    ('routes/web.php',),
    ...
    ('database/migrations/2026_05_22_000001_add_categoria_to_restauranteros_table.php',),
]
