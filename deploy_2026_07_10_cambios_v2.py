"""Deploy Cambios V2: Agenda muestra TODOS los compradores de la plataforma (con
buscador), toggle "?Eres restaurantero?" en Mi Panel (con auto-registro al evento
al activarlo), texto "Ver Proveedores" en EventosSidebar, y modal "Completa tu
perfil" (una vez por sesion) en el panel del proveedor. Sin migraciones nuevas."""
import paramiko, os
