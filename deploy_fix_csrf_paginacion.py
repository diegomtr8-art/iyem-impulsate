"""Fix: correo masivo "Ver destinatarios" tiraba TypeError (faltaba meta csrf-token
en app.blade.php) + paginación mostrando texto crudo pagination.previous/pagination.next
en vez de flechas (Laravel resuelve esas claves de traducción sin lang/ publicado)."""
...
print('\n=== Blade: meta csrf-token ===')
up(sftp, 'resources/views/app.blade.php')

print('\n=== Vistas Vue con paginación corregida (compiladas) ===')
print('  (se suben via public/build, no como .vue directo)')
