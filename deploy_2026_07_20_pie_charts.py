"""Deploy 2026-07-20 (2): Metricas - graficas de pastel animadas para
Distribucion geografica y categorias (municipios/categorias/necesidades).
Solo frontend, no requiere migraciones ni cambios de backend.
"""
import paramiko, os
