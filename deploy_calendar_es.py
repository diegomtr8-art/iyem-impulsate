"""Deploy: Calendario en español (Today→Hoy, Week→Semana, Month→Mes)"""
import paramiko, os
...
print('Conectando...'); ssh.connect(HOST, port=PORT, username=USER, key_filename=KEY_PATH, timeout=30)
print('Conectado OK')
sftp = ssh.open_sftp()
...
ssh.close()
print('\nDeploy OK — calendario ahora en español')
