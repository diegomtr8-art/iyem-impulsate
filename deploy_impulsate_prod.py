"""Deploy a impulsate.iyemyucatan.com — landing mejorada, SEO, favicon, htaccess, controladores"""
import paramiko, os
...
print('Conectando a impulsate.iyemyucatan.com...')
...
print()
print('Cambios:')
print('  - Landing: stats 200+/600+/10+, beneficios, FAQ acordeon')
print('  - SEO: og:title, og:description, twitter:card, meta description')
print('  - Favicon SVG')
print('  - .htaccess: /storage/ -> public/storage/')
print('  - Admin Solicitudes: modal mejorado')
print('  - RestauranteroPanelController: ventanas por rol')
print('  - Evento model: registroAbierto/segundosHasta')
print('  - PATCH /admin/eventos/{evento}')
print('  - socialite instalado')
