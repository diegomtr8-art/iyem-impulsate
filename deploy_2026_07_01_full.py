"""Deploy: Batch completo pendiente (Julio 01) —
Calendario evento + Categorías dinámicas + Correo masivo prueba +
Textos aprobación + Domicilio fiscal en modal + Fixes guardado perfil +
Solicitudes de evento (mails aprobada/rechazada) + Plantillas crear/borrar +
Crédito/factura/logística/perfil_completo + varios ajustes pendientes."""
import paramiko, os
...
run(ssh, f'cd {RROOT} && /usr/bin/php artisan db:seed --class=CategoriasSeeder --force 2>&1')
