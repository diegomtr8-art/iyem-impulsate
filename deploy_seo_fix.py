"""Deploy: SEO, imágenes storage fix, calendario light mode, favicon"""
import paramiko, os
...
print('\n=== [2] JS: app.js (title fix) ===')
up(sftp, 'resources/js/app.js')

print('\n=== [3] Favicon SVG ===')
up(sftp, 'public/favicon.svg')

print('\n=== [4] .htaccess (storage rewrite) ===')
up(sftp, '.htaccess')

print('\n=== [5] Calendario Admin (light mode CSS) ===')
up(sftp, 'resources/js/Pages/Admin/Calendario/Index.vue')

print('\n=== [6] Assets compilados -> public/build/ y build/ ===')
...
ssh.close()
print('\n=== DEPLOY COMPLETADO ===')
print('  https://impulsate.iyemyucatan.com/')
