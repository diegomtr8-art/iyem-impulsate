"""Deploy 2026-07-13: Agenda admin - botones Ver y Borrar.
Agrega AgendaController::show() (detalle de propuesta) y reescribe destroy()
para que haga cascada (borra citas confirmadas si estaba aceptada, luego
agenda_propuesta_citas, luego la propuesta) en vez de bloquear el borrado de
propuestas aceptadas. Nueva ruta GET admin/agenda/{agenda} -> show. Frontend:
Index.vue con boton Ver + modal de confirmacion de borrado (reemplaza el
confirm() nativo), y nueva vista Show.vue con el detalle de la propuesta.
"""
import paramiko, os
